...
output "ecr_repository_url" {
  ...
  description = "Wheres too push the Lambda's Docker image -- docker push <this>:latest"
}
...
output "frontend_bucket_name" {
  ...
  description = "Uploads frontend/ files here (aws s3 sync frontend/ s3://<this-bucket>/)"
}
